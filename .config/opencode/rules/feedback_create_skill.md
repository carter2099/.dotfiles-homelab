...
---
Always use the `/create-skill` skill when creating a new user-level skill. Writing `~/.config/opencode/skills/*/SKILL.md` directly skips the `dotfiles add` + commit + push step, leaving the skill untracked and at risk of being lost if homelab storage is wiped.
