---
name: create-skill
description: Create a new opencode skill, commit it to dotfiles, and push. Always use this instead of writing skill files directly.
---

# Create Skill

Create a new skill under `~/.config/opencode/skills/` and immediately commit it to the dotfiles bare repo so it's backed up to GitHub.
...
```bash
dotfiles add .config/opencode/skills/<name>/SKILL.md
