...
- **MIGRATION COMPLETE** — all headless agents (4 digests, hyperliquid-run, dependabot) + the remote-control daemon are now on opencode. Claude retained for interactive/web use per Carter's intent.
