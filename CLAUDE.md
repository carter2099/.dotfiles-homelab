...
**Architecture pattern:** Apps run on host in Docker Compose. K3s uses ExternalService + Endpoints to route Traefik ingress traffic to host IPs (blog at 192.168.4.92, hub/tbitt/stickies at 192.168.4.102).
