#!/usr/bin/env bash
# Researches and emails the daily agentic platform digest via opencode + MiniMax M3.
...
Prioritize Claude ecosystem news. Include competitor news only when it represents a significant development relevant to production agentic systems. If a source fails to fetch, try another reputable outlet.
